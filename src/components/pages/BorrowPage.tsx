    ...
    <PageContainer>
      <div className="mb-12 text-center">
        ...
        <p className="mx-auto max-w-md text-[17px] leading-[1.28] text-[var(--color-muted-foreground)]">
          Use TITAN as collateral, borrow tUSD, and keep the vault readable.
        </p>
      </div>
      ...
      {!isConnected ? (
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2 font-display text-[30px] leading-[0.98] font-[300] tracking-[-0.03em] sm:text-[34px]">
            ...
            <CardContent className="space-y-6">
              ...
              {hasPosition && (
                <div className={cn(
                  ...
                  isRatioSafe && "bg-[var(--color-primary)]/10",
                  isRatioWarning && "bg-[#efe6bd]",
                  isRatioDanger && "bg-[#f1d9d9]",
                  !isRatioSafe && !isRatioWarning && !isRatioDanger && "bg-[var(--color-foreground)]/5"
                )}>
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                      <div className={cn(
                        "h-3 w-3 rounded-xl",
                        isRatioSafe && "bg-[var(--color-primary)]",
                        isRatioWarning && "bg-[#ba9a29]",
                        isRatioDanger && "bg-[#b84c4c]"
                      )} />
                      <span className="font-medium">Vault Health</span>
                    </div>
                    <span className={cn(
                      "rounded-xl px-3 py-1 text-sm font-semibold",
                      isRatioSafe && "bg-white/72 text-[var(--color-primary)]",
                      isRatioWarning && "bg-white/62 text-[#8d7221]",
                      isRatioDanger && "bg-white/62 text-[#9d3f3f]"
                    )}>
                  ...
                  <div className="mb-4 flex items-end justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <p className={cn(
                        "text-[clamp(2rem,10vw,3rem)] font-bold",
                  ...
                  <div className="relative h-3 overflow-hidden rounded-xl bg-gradient-to-r from-red-300 via-yellow-300 via-50% to-green-300">
                    {/* Marker for current position */}
                    <div
                      className="absolute top-0 bottom-0 w-1 rounded-xl bg-[var(--color-foreground)] transition-all"
                      style={{
              ...
              {/* Wallet Balances */}
              <div className="rounded-xl bg-[var(--color-foreground)]/5 p-4">
                ...
                <TabsContent value="deposit" className="space-y-4 mt-4">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      />
                      <button
                        className="absolute right-3 top-1/2 -translate-y-1/2 rounded-xl px-2 py-1 text-sm font-medium text-[var(--color-titan-green)] transition-colors hover:bg-[var(--color-titan-green)]/10"
                        onClick={() => {
      ...
      <Card className="mt-8">
        ...
        <CardContent>
          <div className="grid md:grid-cols-3 gap-6">
            <div>
              <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-[var(--color-titan-green)]/10">
